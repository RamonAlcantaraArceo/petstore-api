...
from app.api.v1.pets import protected_router as protected_pets_router, unprotected_router as unprotected_pets_router
from app.api.v1.store import router as store_router
from app.api.v1.users import protected_router as protected_users_router, unprotected_router as unprotected_users_router
